 ...
 * @author Gnanod-PC
 */
public class TrainDto extends SuperDto{
    ...
    public TrainDto(String trainId, String engineNumber, boolean firstClass, boolean secondClass, boolean thirdClass, boolean observationSaloon, int firstClassWagonQty, int secondClassWagonQty, int thirdClassWagonQty, int observationSaloonWagonQty, String trainType, String status) {
    ...
    public TrainDto(String trainId, String engineNumber, boolean firstClass, boolean secondClass, boolean thirdClass, boolean observationSaloon, int firstClassWagonQty, int secondClassWagonQty, int thirdClassWagonQty, int observationSaloonWagonQty, String trainType) {
        this.trainId = trainId;
        this.engineNumber = engineNumber;
        this.firstClass = firstClass;
        this.secondClass = secondClass;
    ...
    public TrainDto(String trainId, String engineNumber, boolean firstClass, boolean secondClass, boolean thirdClass, boolean observationSaloon, int firstClassWagonQty, int secondClassWagonQty, int thirdClassWagonQty, int observationSaloonWagonQty, String trainType, String status, String routeStatus) {
        this.trainId = trainId;
        this.engineNumber = engineNumber;
        this.firstClass = firstClass;
        this.secondClass = secondClass;
    ...
    public TrainDto(String trainId, String engineNumber, boolean firstClass, boolean secondClass, boolean thirdClass, boolean observationSaloon, int firstClassWagonQty, int secondClassWagonQty, int thirdClassWagonQty, int observationSaloonWagonQty) {
        this.trainId = trainId;
        this.engineNumber = engineNumber;
        this.firstClass = firstClass;
        this.secondClass = secondClass;
