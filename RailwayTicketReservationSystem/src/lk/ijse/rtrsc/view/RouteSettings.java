 ...
 * @author Gnanod-PC
 */
public class RouteSettings extends javax.swing.JDialog {

    /**
     * Creates new form WagonSettings
     */
    private DefaultTableModel dtmWagonDetail;
    public RouteSettings(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        dtmWagonDetail = (DefaultTableModel) tblRoute.getModel();
        getWagonDetails();        
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(txtUserId, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 20, 400, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 20, 90, 30));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 70, 780, 180));
        ...
        jLabel12.setText("TrainId  68786");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
       try {
            String wagonId = tblRoute.getValueAt(tblRoute.getSelectedRow(), 1).toString();
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        try {
            ...
            String classType = tblRoute.getValueAt(tblRoute.getSelectedRow(), 4).toString();
    ...
    private void tblRouteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblRouteMouseClicked
        ...
        String wagonId = tblRoute.getValueAt(tblRoute.getSelectedRow(), 1).toString();
        String trainId = tblRoute.getValueAt(tblRoute.getSelectedRow(), 2).toString();
        String sheetQty = tblRoute.getValueAt(tblRoute.getSelectedRow(), 4).toString();
        String classType = tblRoute.getValueAt(tblRoute.getSelectedRow(), 3).toString();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RouteSettings.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                RouteSettings dialog = new RouteSettings(new javax.swing.JFrame(), true);
